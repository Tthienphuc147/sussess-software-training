...
@NgModule({
  declarations: [EvaluationPeriodManagerComponent,EvaluationPeriodCreateComponent, EvaluationPeriodEditComponent, EvaluationPeriodFormComponent, EvaluationPeriodListComponent],
  imports: [
    CommonModule,
